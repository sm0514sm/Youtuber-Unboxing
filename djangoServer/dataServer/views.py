...
{code :  -7, yno : null}, Growth 테이블 수집 중 에러
...
def make_new_youtuber(request, url):
    ...
    news_list = get_news_list(youtuber, our_cano_list, datetime.datetime(2000, 1, 1))
    ...
    stat_growth = get_growth()
    print('    - stat_growth : ', stat_growth)
